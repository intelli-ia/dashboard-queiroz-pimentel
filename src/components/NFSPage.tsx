...
export default function NFSPage({ timeRange, setTimeRange, customDates, setCustomDates }: PageProps) {
    ...
    return (
        <div className="p-8 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold">Notas Fiscais de Serviços (NFS)</h1>
                    <p className="text-muted-foreground mt-1">
                        Mapeamento e visualização de notas de serviços prestados
                    </p>
                </div>
